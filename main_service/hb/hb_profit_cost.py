...
def update_hb_car_hotel_profit(days=0):
    ...
    sql = """
        ...
        from PAY_COST_INFO where TRADE_TIME=%s
        group by TRADE_TIME
    """
    dto = [query_date]
    result = DBCli().pay_cost_cli.queryOne(sql, dto)
    ...
    """
    DBCli().targetdb_cli.insert(insert_sql, result)
    ...
    result = DBCli().pay_cost_cli.queryOne(car_sql, dto)
    insert_car_sql = """
    ...
    """
    DBCli().targetdb_cli.insert(insert_car_sql, result)
    ...
    result = DBCli().pay_cost_cli.queryOne(hotel_sql, dto)
    insert_hotel_sql = """
    ...
    """
    DBCli().targetdb_cli.insert(insert_hotel_sql, result)
