...
def update_hotel_newconsumers_daily(days=0):
    """酒店新增消费用户(日), hotel_newconsumers_daily"""
    ...
    query_data = DBCli().tongji_skyhotel_cli.query_all(hotel_newconsumers_sql["hotel_newconsumers_daily"], dto)
    p2p_num = DBCli().tongji_skyhotel_cli.query_one(hotel_newconsumers_sql["hotel_newconsumers_p2p_daily"], dto)
