day_sql = [
    ...
    "select count(1) from hbdt_focus_platform_daily where s_day=%s",
    "select count(1) from hbgj_order_detail_daily_new where s_day=%s",
    ...
    "select count(1) from hbgj_ticket_region_inter_daily where s_day=%s",
    ...
    "select count(1) from weex_installment_activated_type_daily where s_day=%s",
]
